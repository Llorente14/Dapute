...
<body class="bg-[#f4fbf7] font-body antialiased min-h-screen flex flex-col pb-20 md:pb-0">
    ...
    <nav
        ...
        <div class="flex items-center gap-8">
            <a class="text-2xl font-black tracking-tighter text-[#012d1d] font-headline uppercase"
                href="/">Dapute</a>
            <div class="flex gap-6">
                <a class="font-headline font-black tracking-tight uppercase text-[#012d1d]/70 hover:text-[#012d1d] hover:bg-[#d8e2dc] transition-all duration-100 px-2 py-1"
                    href="#">Shop</a>
                <a class="font-headline font-black tracking-tight uppercase text-[#012d1d]/70 hover:text-[#012d1d] hover:bg-[#d8e2dc] transition-all duration-100 px-2 py-1"
                    href="#">About</a>
                <a class="font-headline font-black tracking-tight uppercase text-[#012d1d]/70 hover:text-[#012d1d] hover:bg-[#d8e2dc] transition-all duration-100 px-2 py-1"
        ...
        <div class="flex items-center gap-4 text-[#012d1d]">
            <button
                class="hover:bg-[#d8e2dc] transition-all duration-100 p-2 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none">
                <span class="material-symbols-outlined">shopping_cart</span>
            </button>
            <a href="/profile"
                class="text-[#012d1d] border-b-4 border-[#012d1d] pb-1 p-2 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none">
    ...
    <<<<<<< HEAD <!-- BottomNavBar (Visible on Mobile, Hidden on Web) -->
        <nav
            class="md:hidden fixed bottom-0 left-0 w-full z-50 grid grid-cols-4 h-16 bg-[#f4fbf7] border-t-4 border-[#012d1d]">
            <a class="flex flex-col items-center justify-center text-[#012d1d]/60 py-2 h-full hover:bg-[#d8e2dc]/50 active:scale-95 transition-transform"
                href="#">
            ...
            <a class="flex flex-col items-center justify-center bg-[#d8e2dc] text-[#012d1d] py-2 h-full active:scale-95 transition-transform border-t-4 border-[#012d1d] -mt-1"
                href="/profile">
        ...
        <x-ui.toast />
        >>>>>>> 8881c200062425ae736b46ee409ebbaabd508553
