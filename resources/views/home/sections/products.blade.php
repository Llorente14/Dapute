    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 product-grid">
        ...
        @if($products->count() > 0)
            ...
            @foreach($products->take(4) as $product)
                <div>
                    <div class="group bg-surface-container-lowest border-[3px] border-primary neo-shadow p-4 md:p-6 transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#012d1d] h-full flex flex-col">
