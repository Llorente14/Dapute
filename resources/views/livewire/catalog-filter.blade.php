<div>
    ...
    <section class="bg-[#e8f3ec] border-b-[3px] border-[#012d1d]">
        <div class="w-full max-w-[1200px] mx-auto px-6 py-5">
            <form wire:submit.prevent="searchNow" class="flex flex-col sm:flex-row items-stretch gap-3">
                {{-- Search Input --}}
                <div class="flex-1 relative">
                    ...
                    <div wire:loading wire:target="search,searchNow" class="absolute right-4 top-1/2 -translate-y-1/2">
                ...
                {{-- Search Button (also handles Enter submit) --}}
                <button type="submit"
                        wire:loading.attr="disabled"
                        wire:target="search,searchNow"
    ...
    <section class="w-full max-w-[1200px] mx-auto px-6 pt-10 pb-16 relative">
        ...
        @else
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5" wire:loading.class="opacity-50" wire:target="search,searchNow">
                                ...
                                <div class="flex items-center justify-between mt-auto gap-2">
                                    ...
                                    <button type="button"
                                            ...
                                            class="w-8 h-8 md:w-9 md:h-9 flex items-center justify-center
                                                   ...
                                                   transition-all duration-150 relative disabled:opacity-40 disabled:cursor-not-allowed">
                                        ...
                                        <svg wire:loading wire:target="addToCart('{{ $product['id'] }}')" class="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                    </button>
                                </div>
                            </div>
                        </x-ui.card>
