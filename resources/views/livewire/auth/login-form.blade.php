<div>
    ...
    <main class="w-full max-w-[1000px] grid md:grid-cols-2 gap-8 md:gap-0 bg-surface-container-lowest border-[3px] border-primary shadow-brutal m-auto">
        ...
        <div class="hidden md:block w-full h-full min-h-[600px] border-r-[3px] border-primary relative overflow-hidden bg-surface-container-low">
            <img alt="" class="w-full h-full object-cover grayscale opacity-80 mix-blend-multiply" data-alt="dramatic architectural shot of artisan sourdough bread loaves stacked on metal shelving in a greenhouse setting with natural light and deep shadows" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDHuuuy-Pt9CE6I4b6Tb0ybNcf359KPkxGBqO8TBMq_n8iGT3hKSUL1xmTtfXY0J_K18ceVmNMEapcnctBjK18Rsoy83D1TNgSNBKh-VyNMfYkaLoB97-0YGl-S3GT1gckL2iJRKocR4oSEha0OxQrwG2MBnYXzUw3Rd4ySMeJRyQxFPllYDozkhQ0OijTHskpAzNryk6xCAvgW0NqU-i9jORla2o9SB4o-MueGoxd6uGzNvXBBiMUBu8kcb_dwYkJFs1kBvh-LDW89"/>
            <div class="absolute inset-0 bg-gradient-to-t from-primary/90 to-primary-container/40 p-12 flex flex-col justify-end">
                <h2 class="font-headline font-black text-5xl text-surface-container-lowest tracking-tighter leading-tight mb-4">Dapute</h2>
                <p class="font-body text-surface-container-highest text-lg max-w-sm">Architectural baking. Raw ingredients. Structural honesty.</p>
            </div>
        </div>
        <!-- Right Side: Forms -->
        <div class="w-full p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative bg-surface-container-lowest">
            ...
            <form wire:submit.prevent="login" class="space-y-6">
                ...
                <div class="relative pb-7">
                    <label class="block font-label font-bold text-sm text-primary uppercase tracking-wider mb-2" for="email">Email Address</label>
                    <div class="relative">
                ...
                <div class="relative pb-7">
                    <div class="flex justify-between items-baseline mb-2">
                        <label class="block font-label font-bold text-sm text-primary uppercase tracking-wider" for="password">Password</label>
                        <a class="font-label font-bold text-xs text-primary underline decoration-2 underline-offset-4 hover:text-primary-container" href="#">Forgot Password?</a>
                    </div>
                ...
                <div class="pt-4">
                    <button class="w-full bg-primary text-on-primary border-[3px] border-primary font-label font-bold text-lg uppercase tracking-wider py-4 shadow-brutal hover:shadow-brutal-hover hover:-translate-y-[2px] hover:-translate-x-[2px] transition-all active:translate-y-0 active:translate-x-0 active:shadow-none flex items-center justify-center gap-2" type="submit">
                        <span>Sign In</span>
                    </button>
                </div>
                <div class="mt-8 pt-8 border-t-[3px] border-surface-dim text-center">
                    <p class="font-body text-on-surface-variant font-semibold">
                        ...
                        <a href="/register" class="font-label font-bold text-primary underline decoration-[3px] underline-offset-[6px] hover:text-primary-container px-1 transition-colors ml-2 uppercase">Sign Up</a>
                    </p>
                </div>
            </form>
        </div>
